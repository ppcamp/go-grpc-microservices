...
func (x *UserPasswordInput) Reset() {
	*x = UserPasswordInput{}
...
func (x *UserPasswordInput) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserPasswordInput) ProtoMessage() {}

func (x *UserPasswordInput) ProtoReflect() protoreflect.Message {
	mi := &file_protos_user_password_proto_msgTypes[0]
...
// Deprecated: Use UserPasswordInput.ProtoReflect.Descriptor instead.
func (*UserPasswordInput) Descriptor() ([]byte, []int) {
	return file_protos_user_password_proto_rawDescGZIP(), []int{0}
}

func (x *UserPasswordInput) GetUser() string {
	if x != nil {
		return x.User
	}
	return ""
...
func (x *UserPasswordInput) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
var file_protos_user_password_proto_rawDesc = []byte{
	...
	0x70, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x43, 0x0a, 0x11, 0x55, 0x73, 0x65,
	0x72, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x12, 0x12,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x32, 0x86,
	0x01, 0x0a, 0x13, 0x55, 0x73, 0x65, 0x72, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x36, 0x0a, 0x06, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	0x12, 0x12, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x49,
	...
	0x0a, 0x07, 0x52, 0x65, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x12, 0x12, 0x2e, 0x55, 0x73, 0x65, 0x72,
	0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x1a, 0x16, 0x2e,
...
var file_protos_user_password_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_protos_user_password_proto_goTypes = []interface{}{
	(*UserPasswordInput)(nil), // 0: UserPasswordInput
	(*empty.Empty)(nil),       // 1: google.protobuf.Empty
}
var file_protos_user_password_proto_depIdxs = []int32{
	0, // 0: UserPasswordService.Create:input_type -> UserPasswordInput
	0, // 1: UserPasswordService.Recover:input_type -> UserPasswordInput
	1, // 2: UserPasswordService.Create:output_type -> google.protobuf.Empty
	1, // 3: UserPasswordService.Recover:output_type -> google.protobuf.Empty
...
func file_protos_user_password_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_protos_user_password_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UserPasswordInput); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
